...
class App(QWidget):
    ...
    def __init__(self, conn: sqlite3.Connection, curs: sqlite3.Cursor):
        ...
        self.title = 'Popular Movie Rankings'
        self.left = 0
        self.top = 0
        self.width = 1250
        self.height = 300
    ...
    def createTable(self):
        ...
        self.tableWidget.setRowCount(4)  # rows
        self.tableWidget.setColumnCount(24)  # Columns
        self.tableWidget.setHorizontalHeaderLabels(["rankUpDown", "pop_movie_id", "totalRating", "totalRatingVotes",
        ...
        cursor = conn.cursor()
        query = "SELECT * FROM movie_user_ratings ORDER BY rankUpDown DESC;"
